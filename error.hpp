#ifndef MESH_DECOMPOSER_ERROR_HPP
#define MESH_DECOMPOSER_ERROR_HPP
...
class DomainDecompError : public std::runtime_error
{
public:
    explicit DomainDecompError(const std::string &msg)
...
#endif // MESH_DECOMPOSER_ERROR_HPP
